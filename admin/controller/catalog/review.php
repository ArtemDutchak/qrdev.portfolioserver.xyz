...
class Review extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['filter_statuses'] = $this->model_catalog_review->getReviewsStatuses();
	...
	protected function getList(): string {
		...
		$review_total = $this->model_catalog_review->getTotalCompaniesReviews($filter_data);
		$results = $this->model_catalog_review->getCompaniesReviews($filter_data);
		...
		$data['sort_product'] = $this->url->link('catalog/review|list', 'user_token=' . $this->session->data['user_token'] . '&sort=c.company_name' . $url);
	...
	public function form(): void {
		...
		if (isset($this->request->get['review_id'])) {
			...
			$review_info = $this->model_catalog_review->getCompanyReview($this->request->get['review_id']);
		}
		
		$data['statuses'] = $this->model_catalog_review->getReviewsStatuses();
		...
		if (!empty($review_info)) {
			$data['product'] = $review_info['company'];
		} else {
			$data['product'] = '';
		}
		...
		if (!empty($review_info)) {
			$data['review_status'] = $review_info['status'];
		} else {
