<?php
namespace Opencart\Catalog\Controller\Extension\Feedback\Mail;
...
class Register extends \Opencart\System\Engine\Controller {
	...
	public function index(string &$route, array &$args, mixed &$output): void {
		...
		$data['activation_link'] = $this->url->link('account/activation', 'c=' . $customer['customer_code'], true);
		...
		if ($this->config->get('config_mail_engine')) {
			...
			$mail->setHtml($this->load->view('mail/activation_link', $data));
			$mail->send();
		}
	}
