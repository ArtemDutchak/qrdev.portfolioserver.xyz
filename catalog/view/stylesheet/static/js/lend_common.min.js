...
$(document).ready(function () {
  ...
  //   $('#page > main').animate({'padding-top': $('.header').height()}, 300)
  // })
  ...
  $(".how-it-works-slider").slick({
    ...
    // autoplay: true,
    autoplaySpeed: 3000,
    prevArrow: $('.how-it-works .prevArrow'),
    nextArrow: $('.how-it-works .nextArrow'),
    dots: true,
    appendDots: $('.how-it-works .dots'),
    slidesToShow: 1,
    slidesToScroll: 1,
    responsive: [
      {
  ...
  $(".small-size-areas").each(function (i) {
    // $(".small-size-areas:eq("+i+")").slick({
    $(this).slick({
      infinite: true,
      arrows: false,
      // autoplay: true,
  ...
  $(document).on('click', '.header a[href^="#"]', function (event) {
    event.preventDefault();
    $('html, body').animate({
      scrollTop: $($.attr(this, 'href')).offset().top - headerH + 20
    }, 500);
  });
  
  $('[href="#toTop"]').on('click', function (event) {
    event.preventDefault();
    $('html, body').animate({
      scrollTop: 0
    }, 500);
